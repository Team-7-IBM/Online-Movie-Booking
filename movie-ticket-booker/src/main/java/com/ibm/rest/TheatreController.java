...
import com.ibm.service.TheatreService;
...
public class TheatreController {
	...
	public ResponseEntity<Theatre> findTheatre(@PathVariable int theatreId) throws TheatreNotFoundException {
	...
	public List<Theatre> deleteMoviesById(@PathVariable int theatreId) throws TheatreNotFoundException {
