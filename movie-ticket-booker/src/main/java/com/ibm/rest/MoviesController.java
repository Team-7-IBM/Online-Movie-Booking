...
public class MoviesController {
	...
	public ResponseEntity<Movie> viewMovie(@PathVariable int movieId) throws MovieNotFoundException {
	...
	public ResponseEntity<Movie> removeMovie(@PathVariable int movieId) throws MovieNotFoundException {
